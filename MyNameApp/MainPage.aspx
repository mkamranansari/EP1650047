...
<body>
    ...
    <form id="form1" runat="server">
        <div class="input-text">
            ...
            <asp:TextBox CssClass="text" ID="Value1" runat="server"></asp:TextBox>
			<asp:Label ID="Label2" runat="server" Text="Value 2"></asp:Label>
            <asp:TextBox CssClass="text" ID="Value2" runat="server"></asp:TextBox><br />
			<asp:Button CssClass="button" ID="Add" runat="server" Text="Add" OnClick="Add_Click" /><br />
			<asp:Button CssClass="button" ID="Multiply" runat="server" Text="Multiply" OnClick="Multiply_Click" /><br />
			<asp:Button CssClass="button" ID="Subtract" runat="server" Text="Subtract" OnClick="Subtract_Click" /><br />
			<asp:Button CssClass="button" ID="Divide" runat="server" Text="Divide" OnClick="Divide_Click" /><br />
        </div>
